...
def get_parser():
    ...
    parser.add_argument('--result_root', type=str, default='results/vqldm')
    parser.add_argument('--image_save_dir', type=str, default='results/vqldm/vqldm_2d_test_2024-01-17T22-40-15/rect_images_2')
...
class LDM(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        z_0 = x_samples.data.cpu().numpy()
        z_1 = z.data.cpu().numpy()

        fea_save_dir = 'results/vqldm/vqldm_2d_test_2024-01-17T22-40-15/features_2'
        fea_name = x_id[0]
        np.savez(os.path.join(fea_save_dir, fea_name), z_0=z_0, z_1=z_1, label=c['c3'].data.cpu().numpy())
...
def main(opts):
    ...
    if opts.command == "fit":
        ...
        path = 'results/vqldm/vqldm_2d_test_2024-01-17T22-40-15/lightning_logs/version_0/checkpoints/model-epoch=199.ckpt'
