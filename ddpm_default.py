...
from ldm.modules.diffusionmodules.openaimodel1 import UNetModel1
...
class DiffusionWrapper(pl.LightningModule):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        assert self.conditioning_key in [None, 'concat', 'crossattn', 'hybrid', 'adm', 'hybrid-adm', 'fine-diff']

        if self.conditioning_key == 'fine-diff':
            self.diffusion_model = UNetModel1(**diff_model_config)
        else:
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None, c_adm=None):
        ...
        elif self.conditioning_key == 'fine-diff':
            out = self.diffusion_model(x, t, context=c_concat)
